...
@section('content')
    <div class="container mx-auto p-6">
        <h1 class="text-2xl font-bold text-brown-600 mb-4">Criar Nova Oferta</h1>
        <form method="POST" action="{{ route('job-offers.store') }}" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4 flex space-x-4">
                <div class="flex-1">
                    ...
                    <input type="number" name="salary_min" id="salary_min" step="0.01" value="{{ old('salary_min') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                ...
                <div class="flex-1">
                    ...
                    <input type="number" name="salary_max" id="salary_max" step="0.01" value="{{ old('salary_max') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="keywords" id="keywords" value="{{ old('keywords') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
            </div>
            <div class="mb-4">
                <label for="expires_at" class="block text-sm font-medium text-gray-700">Data de Expiração</label>
                <input type="date" name="expires_at" id="expires_at" value="{{ old('expires_at') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
            ...
            <button type="submit" class="bg-brown-600 text-white px-4 py-2 rounded hover:bg-brown-700">Criar Oferta</button>
        </form>
    </div>
@endsection
